                                    ...
                                    <div class="property-item">
                                        ...
                                        <?php }else {?>
                                            <div class="property--info">
                                                <h5 class="property--title"><a href="property-single-gallery.php?id=<?php echo $result['property_id'];?>"><?php echo $result['property_type'];?> in <?php echo $result['property_city'];?>,<?php echo $result['property_state'];?> </a></h5>
                                                <p class="property--location"> <img src="assets/images/favicon/location-address.png" alt=""> <sapn style="color:black;"><?php echo $result['property_address'];?> </sapn>  </p>
                                        <?php }?>
                                               <?php if($q==0)
                                                {?>
                                                    <p class="property--price1" style="font-size: 20px;">
                                                        Rs. <?php 
                                                        echo moneyFormatIndia($result['property_price']);?><p1 style="color: #282828; font-size: 18px;"> / per month</p><p1 style="color: #f33408; font-size: 20px;" > Deposite : <?php 
                                                        echo moneyFormatIndia($result['deposite']);?></p>
                                                    
                                                <?php }else {?>
                                                     <p class="property--price">Rs. <?php 
                                                        echo moneyFormatIndia($result['property_price']);?> <br><p1 style="color: #f33408; font-size: 20px;" >Token : <?php 
                                                        echo moneyFormatIndia($result['deposite']);?></p>
                                                <?php }?>
                                            </div>
                                            <!-- .property-info end -->

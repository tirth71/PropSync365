...
?>
    ...
    <!-- Contact #1
============================================= -->
    <section id="add-property" class="my-properties properties-list" style="padding-top: 0px;
    padding-bottom: 0px;">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php if ($q == 0) { ?>
                                                    ...
                                                    <p class="property--price1" style="font-size: 20px;">
                                                        Rs. <?php
                                                            echo moneyFormatIndia($result['property_price']); ?><p1 style="color: #282828; font-size: 18px;"> / per day</p>
                                                    <p1 style="color: #f33408; font-size: 20px;"> Deposite.<?php
                                                                                                            echo moneyFormatIndia($result['deposite']); ?></p>

                                                    <?php } else { ?>
                                                        <p class="property--price">Rs. 
                                                            <?php echo moneyFormatIndia($result['property_price']); ?></p>
                                                    <?php } ?>
                                                </div>
                                                <!-- .property-info end -->
                                                <div class="property--features">
                                                    <ul>
                                                        <li><span class="feature m-0"><img src="assets/images/favicon/bad.png" alt=""></span><span class="feature-num"><?php echo $result['property_totalbeds']; ?> beds</span></li>
                                                        <li><span class="feature m-0"><img src="assets/images/favicon/bath.png" alt=""></span><span class="feature-num"><?php echo $result['property_totalbaths']; ?> baths</span></li>
                                                        <li><span class="feature m-0"><img src="assets/images/favicon/squre.png" alt=""></span><span class="feature-num"><?php echo $result['property_sqfeet']; ?> sq</span></li>

                                                    </ul>
                                                    <div>
                                                        <li><a href="edit-property.php?id=<?php echo $result['property_id']; ?>" class="edit--btn my-propertys-eit-btn-owner"><i class="fa fa-edit"></i>Edit</a></li>
                                                    </div>
                                                </div>
